...
class SyntheticDataGenerator:
    def data_1(self, n_samples: int, n_features: int, n_informative: int, ro: float, snr: float = 1.0):
        ...
        y = self._calculate_target(X, beta, snr)
        return X, y, beta


    def data_2(self, n_samples: int, n_features: int, snr: float = 1.0):
    ...
    def data_3(self, n_samples: int, n_features: int, snr: float = 1.0):
    ...
    def data_4(self, n_samples: int, n_features: int, snr: float = 1.0):
    ...
    @staticmethod
    def _calculate_target(X: np.ndarray, beta: np.ndarray, snr: float):
...
if __name__ == "__main__":
    ...
    X, y, beta = generator.data_1(n_samples, n_features, n_informative, ro)
    print("Data 1:")
    print("X shape:", X.shape, )
    print("y shape:", y.shape)
    print("beta", beta)

    X, y, beta = generator.data_2(n_samples, n_features)
    print("\nData 2:")
    print("X shape:", X.shape)
    print("y shape:", y.shape)
    print("beta", beta)

    X, y, beta = generator.data_3(n_samples, n_features=12)
    print("\nData 3:")
    print("X shape:", X.shape)
    print("y shape:", y.shape)
    print("beta", beta)

    X, y, beta = generator.data_4(n_samples, n_features = 12)
    print("\nData 4:")
    print("X shape:", X.shape)
    print("y shape:", y.shape)
    print("beta", beta)